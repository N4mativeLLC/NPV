...
public class Campaign {
	...
	private String eventBrowser;
	private String eventOperatingSystem;
	...
	public String getEventBrowser() {
		return eventBrowser;
	}

	public void setEventBrowser(String eventBrowser) {
		this.eventBrowser = eventBrowser;
	}

	public String getEventOperatingSystem() {
		return eventOperatingSystem;
	}

	public void setEventOperatingSystem(String eventOperatingSystem) {
		this.eventOperatingSystem = eventOperatingSystem;
	}
